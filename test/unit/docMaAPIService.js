...
describe('docMaAPI service', function() {
  ...
  describe('v1', function() {
    ...
    it('should create doc number', function(done) {
      ...
      $httpBackend
        .expectPOST('/v1/docs/1/doc_numbers/')
        .respond(201, data);
    ...
    it('should delete doc number', function(done) {
      $httpBackend
        .expectDELETE('/v1/docs/doc_numbers/1')
        .respond(200, {});

      var promise = client.docs.deleteDocNumber(1);
    ...
    it('should find all docs by label', function(done) {
      ...
      $httpBackend
        .expectGET('/v1/docs?label_name=l1')
        .respond(200, [data]);

      var docs = client.docs.findDocsByLabel('l1');
      docs.$promise.then(function(resp) {
        expect(resp.status).toBe(200);
        expect(docs[0].id).toEqual(1);
        done();
    ...
    it('should join label with doc', function(done) {
      ...
      $httpBackend
        .expectPOST('/v1/labels/docs/')
        .respond(202, data);

      var ref = client.labels.joinLabelWithDoc(1, 2);
    ...
    it('should detach label from doc', function(done) {
      $httpBackend
        .expectDELETE('/v1/labels/1/docs/2')
        .respond(202, {});

      var promise = client.labels.detachLabelFromDoc(1, 2);
      promise.then(function(resp) {
        expect(resp.status).toBe(202);
        done();
      });
